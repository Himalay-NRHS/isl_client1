  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-6">
        ...
        <div className="min-h-[200px] bg-white dark:bg-gray-800 rounded-xl p-4 border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center">
      ...
      {/* Convert Button */}
      <div className="text-center">
        <button className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-colors duration-200 shadow-lg hover:shadow-xl">
